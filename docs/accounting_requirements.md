...
**文档维护**: 产品团队
**最后审核**: 2026-02-09
**技术栈更新**: React 前端 + Spring Boot 后端（Flutter 和 Python FastAPI 已废弃）
