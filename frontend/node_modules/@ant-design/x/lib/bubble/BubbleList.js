...
var _omit = _interopRequireDefault(require("@rc-component/util/es/omit"));
var _pickAttrs = _interopRequireDefault(require("@rc-component/util/es/pickAttrs"));
...
const BubbleList = (props, ref) => {
  ...
  const {
    scrollTo
  } = (0, _useCompatibleScroll.useCompatibleScroll)(scrollBoxDom);
