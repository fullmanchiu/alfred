...
class Transaction {
  ...
  factory Transaction.fromJson(Map<String, dynamic> json) {
    // Handle nested structure from backend: {category: {id: ..., name: ...}, from_account: {id: ...}, to_account: {id: ...}}
    ...
    return Transaction(
      ...
      fromAccountId: json['from_account']?['id'] ?? json['from_account_id'],
      toAccountId: json['to_account']?['id'] ?? json['to_account_id'],
