    ...
    <div style={{ paddingTop: 'var(--spacing-xl)', paddingBottom: '6.25rem', padding: 'var(--spacing-xl)', maxWidth: '75rem', margin: '0 auto' }}>
      ...
      >
        {modalVisible && (
          ...
          {/* 图标选择 */}
          <Form.Item label={t('categories.fields.icon')} name="iconName" initialValue={MATERIAL_ICON_CATEGORIES[0].icons[0].code}>
            {() => (
              <IconPicker
                form={form}
                selectedColor={form.getFieldValue('color')}
                columns={6}
                maxHeight="320px"
                gap="0.25rem"
              />
          ...
          {/* 颜色选择 */}
          <Form.Item label={t('categories.fields.color')} name="color" initialValue={COLOR_PRESETS[0]}>
              ...
              {COLOR_PRESETS.map((color) => (
                <div
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    border: form.getFieldValue('color') === color ? '2px solid var(--color-text-primary)' : '1px solid var(--color-border)',
                    transition: 'all 0.2s',
                    transform: form.getFieldValue('color') === color ? 'scale(1.1)' : 'scale(1)',
                  }}
                />
              ))}
            </div>
