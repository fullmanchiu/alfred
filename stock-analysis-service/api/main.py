...
# 导入分析模块
from modules import data_fetcher, technical_analysis, fundamental_analysis, ai_analyzer, risk_management
...
@app.post("/api/stock/analyze", tags=["股票分析"])
...
@app.post("/api/stock/{code}/ai-report", tags=["股票分析"])
